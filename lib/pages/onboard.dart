...
import 'package:fooddeliveryapp/widget/contentMode.dart';
            ...
            child: PageView.builder(
              ...
              return Padding(padding: EdgeInsets.only(top: 40.0, left: 20.0, right: 20.0),
                child: Column(children: [
                  Image.asset(contents[i].image, height: 380,
                  ...
                  Text(contents[i].descritpion, style: AppWidget.LightTextFeildStyle(),),
                ],),
              );
            }),
          ),
